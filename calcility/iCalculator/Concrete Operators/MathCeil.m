...
- (MathResult *)operate
{
    ...
    decQuad resultValue;
    decQuadToIntegralValue(&resultValue, &contentValue, &DQ_set, DEC_ROUND_CEILING);
...
- (CGRect)drawWithContext:(MathDrawingContext *)context
{
    ...
    if (hemiGlyphPath == NULL) {
        ...
        CGPathMoveToPoint(hemiGlyphPath, NULL, 0.3, 1.0);
        CGPathAddLineToPoint(hemiGlyphPath, NULL, 0.3, -1.0);
        CGPathAddLineToPoint(hemiGlyphPath, NULL, 0.8, -1.0);
    }
